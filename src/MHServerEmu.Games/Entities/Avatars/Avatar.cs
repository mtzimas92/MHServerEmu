...
namespace MHServerEmu.Games.Entities.Avatars
{
    public partial class Avatar : Agent
    {
        ...
        // [Rift Access] Avengers Tower NPCs for direct access to higher difficulty raid/patrol content.
        // Misty Knight and Doctor Strange match the validated interactable NPC prototypes from the T4/T5
        // access work; patchdata places them into Avengers Tower.
        private static readonly PrototypeId OmegaPatrolTeleporterRef = (PrototypeId)1753661696525930987;
        private static readonly PrototypeId RaidAccessTeleporterRef = (PrototypeId)13792587214021661359;
...
// V48_TODO: specialization powers
        ...
        public override bool UseInteractableObject(ulong entityId, PrototypeId missionRef)
        {
            ...
            else if (interactableObject.PrototypeDataRef == RaidAccessTeleporterRef)
                UseRaidAccessTeleporter(player, interactableObject);
            else if (interactableObject.PrototypeDataRef == OmegaPatrolTeleporterRef)
